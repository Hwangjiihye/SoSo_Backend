...
public class AccountController {
	...
	public ResponseEntity<String> insertAccount(@RequestBody AccountDTO dto) {
	...
	public ResponseEntity<List<AccountDTO>> accountList(@RequestParam Long storeSeq) {
		List<AccountDTO> list = accountServ.accountList(storeSeq);
